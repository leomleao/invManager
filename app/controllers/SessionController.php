...
class SessionController extends ControllerBase
{
    ...
    {      
        ...
        // BEGIN CSS
            ...
            $pagePluginsCss->addCss('assets/plugins/socicon/socicon.min.css');            
     ...
     * @param Users $user
     */
    private function _registerSession(Users $user, Departments $department)
    {
            $this->session->set('auth', array(
            'userID'    => $user->getUserID(),
            'userName'  => $user->getUserName(),
            'userUser'  => $user->getUserUser(),
            'userDpt'   => $department->getDepartmentName()
        ));
    }
                ...
                if ($user) {
                    ...
                    if ($user->getUserStatus() === '1'){
                        ...
                        if (LoginAttempts::attempts($user)){
                            ...
                            $department = Departments::findFirstByDepartmentID($user->getUserDepartmentID());                           
                            $this->_registerSession($user, $department);
